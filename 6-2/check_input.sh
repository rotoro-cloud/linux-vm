...
iptables -L INPUT -n | tail -1 | awk '{print $5}'| grep '0.0.0.0/0' && iptables -L INPUT -n | tail -1 | awk '{print $4}'| grep '0.0.0.0/0' && iptables -L INPUT -n | tail -1 | awk '{print $2}'| grep "all\|0"
