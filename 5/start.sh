...
mkdir -p /home/max/cave-of-cmds/cow-house/pile-of-garbage;mkdir -p /home/max/cave-of-cmds/stable;mkdir -p /home/max/cave-of-cmds/garbage-dump;mkdir -p /opt/drak-app/red/yellow/orange;mkdir -p /opt/drak-app/yellow/orange/red;mkdir -p /opt/drak-app/orange/red/yellow;mkdir -p /home/max/tmp/forest/
