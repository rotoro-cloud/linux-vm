...
sshpass -p supeRbison ssh -o StrictHostKeyChecking=no max@app01 "echo supeRbison | sudo -S echo 'app01' > cat /etc/hostname; echo supeRbison | sudo -S echo \"$my_ip ws01\" >> /etc/hosts; cat /etc/hostname; cat /etc/hosts"
